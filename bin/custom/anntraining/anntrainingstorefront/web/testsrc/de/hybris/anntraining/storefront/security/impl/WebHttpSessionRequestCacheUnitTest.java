...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/anntrainingstorefront/electronics/en",
						"https://electronics.local:9002/anntrainingstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/anntrainingstorefront/electronics/en",
						"https://electronics.local:9002/anntrainingstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/anntrainingstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/anntrainingstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/anntrainingstorefront/electronics/en",
						"https://electronics.local:9002/anntrainingstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/anntrainingstorefront",
						"https://electronics.local:9002/anntrainingstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/anntrainingstorefront",
						"https://electronics.local:9002/anntrainingstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/anntrainingstorefront/electronics/en",
						"https://electronics.local:9002/anntrainingstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
