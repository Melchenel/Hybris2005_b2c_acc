 ...
 */
package de.hybris.anntraining.core.suggestion;
...
import de.hybris.anntraining.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/anntrainingcore/test/testSimpleSuggestionService.csv", "utf-8");
	}
