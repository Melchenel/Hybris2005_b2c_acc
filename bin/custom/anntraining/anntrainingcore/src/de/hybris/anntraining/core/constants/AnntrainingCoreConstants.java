 ...
 */
package de.hybris.anntraining.core.constants;

/**
 * Global class for all AnntrainingCore constants. You can add global constants for your extension into this class.
 */
public final class AnntrainingCoreConstants extends GeneratedAnntrainingCoreConstants
{
	public static final String EXTENSIONNAME = "anntrainingcore";


	private AnntrainingCoreConstants()
	{
		//empty
	}
