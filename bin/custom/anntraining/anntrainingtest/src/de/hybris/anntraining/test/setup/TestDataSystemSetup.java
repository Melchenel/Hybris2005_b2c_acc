 ...
 */
package de.hybris.anntraining.test.setup;
...
import de.hybris.anntraining.test.constants.AnntrainingTestConstants;
import de.hybris.anntraining.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AnntrainingTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/anntrainingtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/anntrainingtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/anntrainingtest/import/cstickets.impex");
			...
			importImpexFile(context, "/anntrainingtest/import/csquotes.impex");
		}
	}
}
