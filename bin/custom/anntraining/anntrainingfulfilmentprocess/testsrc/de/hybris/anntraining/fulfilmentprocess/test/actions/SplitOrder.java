 ...
 */
package de.hybris.anntraining.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(AnntrainingFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AnntrainingFulfilmentProcessConstants.PARENT_PROCESS);
