 ...
 */
package de.hybris.anntraining.fulfilmentprocess.test.jobs;
...
import de.hybris.anntraining.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = AnntrainingFulfilmentProcessConstants.ORDER_PROCESS_NAME;
